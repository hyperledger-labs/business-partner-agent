...
3. Make a copy of the provided [.env-example file](.env-example) with the name `.env`. Set the `ACAPY_SEED` to the wallet seed. Repeat this process for the second DID, and set the `ACAPY_SEED2` to the second wallet seed.
