 ...
 */
package org.hyperledger.oa.controller.api.exception;
...
public class WrongApiUsageExceptionHandler implements ExceptionHandler<WrongApiUsageException, HttpResponse<?>> {
    ...
    @Override
    public HttpResponse<?> handle(@SuppressWarnings("rawtypes") HttpRequest request, WrongApiUsageException exception) {
