...
class MyDocumentManagerTest extends RunWithAries {
    ...
    void testSaveNewCredential() throws Exception {
        ...
        assertSame(CredentialType.INDY_CREDENTIAL, myCred.getType());
    ...
    void testSaveIndyDocumentNoSchemaId() {
        Exception exception = assertThrows(WrongApiUsageException.class, () -> {
            ...
            document.setType(CredentialType.INDY_CREDENTIAL);
    ...
    void testUpdateCredential() throws Exception {
        ...
        MyDocumentAPI credential = utils.createDummyCred(CredentialType.INDY_CREDENTIAL, Boolean.FALSE);
        ...
        assertSame(CredentialType.INDY_CREDENTIAL, result.get().getType());
    ...
    void testDeleteMyCredential() throws Exception {
        ...
        MyDocumentAPI credential2 = utils.createDummyCred(CredentialType.INDY_CREDENTIAL, Boolean.FALSE);
    ...
    private MyDocumentAPI createAndSaveDummyCredential() throws JsonProcessingException {
        return createAndSaveDummyCredential(CredentialType.INDY_CREDENTIAL, Boolean.FALSE);
    }

    private MyDocumentAPI createAndSavePublicDummyCredential() throws JsonProcessingException {
        return createAndSaveDummyCredential(CredentialType.INDY_CREDENTIAL, Boolean.TRUE);
    }
