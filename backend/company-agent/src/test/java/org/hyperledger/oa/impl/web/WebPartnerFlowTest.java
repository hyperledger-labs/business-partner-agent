...
class WebPartnerFlowTest extends BaseTest {
    ...
    void testResolvePublicKeyWithKeyId() throws Exception {
        ...
        final Optional<PublicKey> publicKey = WebPartnerFlow.resolvePublicKey(didDoc.getDidDocument().getPublicKey());
    ...
    void testResolvePublicKeyNoKeyId() throws Exception {
        ...
        final Optional<String> matchKey = WebPartnerFlow.matchKey(null, didDoc.getDidDocument().getPublicKey());
    ...
    void testResolvePublicKeyKeyIdProvided() throws Exception {
        DidDocument didDoc = loadAndConvertTo("files/didLocal.json", DidDocument.class);
        final Optional<String> matchKey = WebPartnerFlow.matchKey(
