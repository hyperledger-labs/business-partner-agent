...
public class TransactionManager {
    ...
    public void handleEndorserTransactionEvent(@NonNull EndorseTransactionEvent transaction) {
                ...
                partner.ifPresentOrElse(
                    p -> {
                        BPATransaction txn = BPATransaction
                            .builder()
                            .createdAt(TimeUtil.parseZonedTimestamp(transaction.getCreatedAt()))
                            .partner(p)
                            ...
                            .updatedAt(TimeUtil.parseZonedTimestamp(transaction.getUpdatedAt()))
                            .build();
