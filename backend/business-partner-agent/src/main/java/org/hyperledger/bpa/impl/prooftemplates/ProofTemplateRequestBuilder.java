...
public class ProofTemplateRequestBuilder<Predicate, Attribute, Restrictions> {
    ...
    public ProofTemplateRequestBuilder(
            Function<String, Predicate> predicateCreator,
            Function<String, Attribute> attributeCreator,
            Supplier<Restrictions> restrictionCreator) {
        this.predicateCreator = predicateCreator;
        this.attributeCreator = attributeCreator;
        this.restrictionCreator = restrictionCreator;
    }

    public Predicate addPredicate(@NotEmpty String name) {
        return predicates.computeIfAbsent(name, predicateCreator);
    }

    public Attribute addAttribute(@NotEmpty String name) {
