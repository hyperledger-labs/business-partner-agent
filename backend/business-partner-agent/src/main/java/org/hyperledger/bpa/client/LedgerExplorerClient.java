 ...
 * The client is not active if no browser URL is configured.
 * Installing a ledger explorer can be done in three steps:
 * 1. Clone the repository
 * 2. Provide a genesis file
 * 3. Create a systemd service unit like
 *
 * [Unit]
 * Description=IndyNode
 ...
 * User=indy
 * Group=docker
 * ExecStart=/opt/von-network/manage start-web GENESIS_FILE=/home/indy/genesis/idu_genesis LEDGER_INSTANCE_NAME=MyName
