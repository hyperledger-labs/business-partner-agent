...
public class SanitizingDeserializerTest {

    private final ObjectMapper mapper = new ObjectMapper();

    @Test
    void testDeserializeWithHtml() throws Exception {
        MessageTemplateCmd.MessageTemplateRequest input = new MessageTemplateCmd.MessageTemplateRequest();
        input.setSubject("<a href=''></a> karl");
