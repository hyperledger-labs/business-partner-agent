...
Regarding release process, we do not follow a strict process yet. Releases are in general conidered "alpha", which means API may change at any time.
Find more on that in [Publishing](PUBLISHING.md).
